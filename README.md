...
using R and Bioconductor packages. In particular, we will use DESeq2 for differential expression analysis, which is one of the most popular and robust methods for RNA-seq analysis.
